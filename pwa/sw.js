...
const h = {
  ...
  l = (t) => [h.prefix, t, h.suffix].filter((t) => t && t.length > 0).join("-"),
  u = (t) => t || l(h.precache),
  f = (t) => t || l(h.runtime);
function w(t, e) {
  const s = e();
...
class b {
  constructor(t, e) {
    (this.l = {}),
      ...
      (this.R = [...t.plugins]),
      (this.v = new Map());
    for (const t of this.R) this.v.set(t, {});
...
class L {
  ...
  async U(t, s, n) {
    ...
    try {
      if (((i = await this._(s, t)), !i || "error" === i.type))
      ...
      });
    {
      ...
      (n = await s.fetch(
        ...
        e &&
          o &&
          "no-cors" !== t.mode &&
          (this.T(), await s.cachePut(t, n.clone()));
    }
    return n;
  }
  async O(t, s) {
...
class C {
  ...
  addToCacheList(t) {
    ...
    for (const n of t) {
      ...
      if ((this.K.set(i, t), this.P.set(i, r), s.length > 0)) {
...
self.addEventListener("message", (t) => {
  ...
  (function (t) {
    ...
    { url: "assets/index-B5TQbqVl.js", revision: null },
    { url: "assets/index-CBlleRSw.css", revision: null },
    { url: "index.html", revision: "650251fcd8011e07507325cc54b19675" },
    {
      url: "pwa/manifest.webmanifest",
      revision: "211a3ad5767ea5c51aa34472cc0ad31e",
    },
  ]),
  (function (t) {
    const e = O();
  ...
  c(
    new (class extends n {
      constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
        super((t) => this.j(t), t), (this.k = e), (this.I = s);
      }
      j({ url: t, request: e }) {
        if (e && "navigate" !== e.mode) return !1;
        const s = t.pathname + t.search;
        for (const t of this.I) if (t.test(s)) return !1;
        return !!this.k.some((t) => t.test(s));
      }
    })(((K = "index.html"), O().createHandlerBoundToURL(K)))
  );
